...
const navItems = [
  ...
  { href: '/calendar', icon: Calendar, label: 'カレンダー', disabled: true },
  { href: '/reports', icon: BarChart2, label: 'レポート', disabled: true },
  { href: '/settings', icon: Settings, label: '設定', disabled: true },
]
